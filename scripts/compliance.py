...
_add(["最低价", "最省", "最具性价比", "最舒适", "最安全"],
     "P0", "绝对化-最字系", "改为「高性价比」「实惠装」等相对表述")
_add(["中国第一", "全球第一", "亚洲第一", "首席", "首选", "首选品牌"],
     "P0", "绝对化-排名", "改为「热销款」「口碑款」，或标注可查证的榜单来源")
_add(["顶尖", "无敌", "秒杀全网", "碾压级", "天花板"],
     "P0", "绝对化-顶级系", "改为「高配」「进阶款」等可自证表述")
_add(["国家指定", "国家授权", "国家机关推荐", "政府指定", "特批"],
     "P0", "禁止性-国家机关名义", "广告法第九条禁止使用国家机关名义，必须删除")
...
_add(["增强免疫力", "辅助降血压", "辅助降血糖", "辅助降血脂", "改善睡眠",
      "缓解体力疲劳", "通便", "护肝", "养胃"],
     "P1", "保健功能声称", "属保健食品功能声称，须有蓝帽子批文，普通食品禁用")
_add(["医用级", "医疗级", "药妆", "临床验证", "祛湿", "驱寒", "活血"],
     "P1", "医疗功效用语", "非药品/械字号不得宣称，改为「温和」「护理」类表述")
_add(["医院同款", "药店同款", "运动员指定", "航空品质"],
     "P1", "需授权证明", "须有被引用方书面授权或采购凭证，否则删除")
